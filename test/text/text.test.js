...
test("文本-反转文本", async () => {
	...
	input = "![文本-反转文本]";
	expect(await showTextBrowser(input)).toBe("![文本-反转文本]");
});
...
test("文本-取文本左", async () => {
	...
	input = "![文本-取文本左]";
	expect(await showTextBrowser(input)).toBe("![文本-取文本左]");
});
...
test("文本-取文本右", async () => {
	...
	input = "![文本-取文本右]";
	expect(await showTextBrowser(input)).toBe("![文本-取文本右]");
});
...
test("文本-取数字", async () => {
	...
	input = "![文本-取数字]";
	expect(await showTextBrowser(input)).toBe("![文本-取数字]");
});
...
test("文本-替换", async () => {
	...
	input = "![文本-替换]";
	expect(await showTextBrowser(input)).toBe("![文本-替换]");
});
